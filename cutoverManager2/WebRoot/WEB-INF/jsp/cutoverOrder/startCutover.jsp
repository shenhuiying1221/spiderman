...
<!--显示表单内容-->
<div id=MainArea>
    <s:form action="cutoverOrderAction_startCutover.action">
        ...
        <div class="ItemBlockBorder">
            <div class="ItemBlock">
                <table cellpadding="0" cellspacing="0" class="mainForm">
                    <tr>
                    	<td>割接配合人</td>
                        <td><s:textfield name="cooperatorName" cssClass="InputStyle"></s:textfield></td>
                    </tr>
                    <tr>
                    	<td>割接联系方式</td>
                        <td><s:textfield name="cooperatorPhone" cssClass="InputStyle"></s:textfield></td>
                    </tr>
